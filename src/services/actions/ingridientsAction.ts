...
export const GET_MENU_REQUEST_FAILED: "GET_MENU_REQUEST_FAILED" = "GET_MENU_REQUEST_FAILED";
export const GET_MENU_REQUEST_FINISH: "GET_MENU_REQUESЕ_FINISH" = "GET_MENU_REQUESЕ_FINISH";
